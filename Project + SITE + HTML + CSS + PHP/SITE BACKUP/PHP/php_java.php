...
<html>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; script-src 'self'; style-src 'self' https://fonts.googleapis.com; img-src 'self'; font-src 'self' https://fonts.gstatic.com;">
        ...
        <script src="js/phpJsTest.js" defer></script>
...
<nav>
    <ul class="menu-4">
        ...
        <li><a href="/b374k/index.php" data-hover="b374k">b374k</a></li>
        <li><a href="/shellPHP/simplewebshell.php" data-hover="SHELLPHP">SHELLPHP</a></li>
        <li><a href="/calc.php" data-hover="Calc JS">Calc JS</a></li>
        <li><a href="/phpMain.php" data-hover="PHP TEST ALL">PHP TEST ALL</a></li>
        <li><a href="/php1.php" data-hover="JS">JS</a></li>
        <li><a href="/php_java.php" data-hover="PHP_JS_DB">PHP_JS_DB</a></li>
